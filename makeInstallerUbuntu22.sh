#!/bin/bash
# ------------------------------------------------------------------------------
# NiDB Ubuntu 22.04 (jammy) package builder
...
# names a different build directory (e.g. bin/ubuntu22), as used by makeAllInstallers.sh.
#
# Same as the Debian 12 builder; jammy uses the same package names. jammy ships
# PHP 8.1 and MariaDB 10.6; the postinst detects the PHP version at runtime, so
