...
Next steps to import the data correctly from redcap into NiDB is testing the connection and mapping each variable / field from redcap to NiDB. To test and established the connection with Redcap follow the following steps:
...
To start mapping Click on the "Map This Project" button at the end of screen as shown in the above figure. A new page will appear as shown below.
