			...
			foreach ($alldata as $uid => $studies) {
				foreach ($studies as $studynum => $series) {
					foreach ($series as $seriesnum => $metrics) {
						$rowstr = "{ uid: \"$uid\", studynum: \"$studynum\", seriesnum: \"$seriesnum\"";
			...
			<script type="text/javascript">
				...
				const gridOptions = {
					...
					columnDefs: [
						...
						{ headerName: "StudyNum", field: "studynum", editable: false },
						{ headerName: "SeriesNum", field: "seriesnum", editable: false },
						<?
