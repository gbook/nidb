	...
	<div class="ui grid">
		<div class="four column row">
			...
			<div class="right floated column">
				<h3 class="ui top attached inverted header" align="right">Redcap Server: <?=$redcapurl?>  </h3>
			</div>
		</div>
	...
	<form  class="ui form" action="redcapmapping.php">
		...
		<table class="ui green large centered table" align="center">
				...
				<td>
					 <div class=content>
				           <div class="ui field">
				                <h3> Select Redcap Form to map (List follows Redcap Sequence)</h3>
				                <select class="ui search dropdown" name=inst required>
				...
				<td> 
					<div class=content>
                                           <div class="ui field">
						<h3> Select the Redcap Form Containg Unique Id to join data from Redcap and NiDB</h3>
						<select class="ui search dropdown" name=uinst required>
                                                <option selected disabled>Redcap Forms </option>
                                                <?for($In=0;$In < count($In_Name); $In++){ ?>
                                                   <option value=<?=$In_Name[$In]?>> <?=$In_Name[$In]?> </option>
                                               <?}?>
