...
cp -f ~/Qt/6.9.0/gcc_64/lib/libicudata.so.56 %{buildroot}/usr/lib/ # copy Qt libs
cp -f ~/Qt/6.9.0/gcc_64/lib/libicui18n.so.56 %{buildroot}/usr/lib/ # copy Qt libs
cp -f ~/Qt/6.9.0/gcc_64/lib/libicuuc.so.56 %{buildroot}/usr/lib/ # copy Qt libs
