...
BuildArch:	x86_64
BuildRequires:  gcc, cmake, make   # 'cmake3' is required by CentOS 8, 'cmake' is required by centOS 8 Stream. Make sure the right one is used depending on your build OS
