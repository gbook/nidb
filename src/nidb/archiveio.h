...
public:
	...
	bool WriteSquirrel(qint64 exportid, QString name, QString desc, QStringList downloadflags, QStringList squirrelflags, QList<qint64> seriesids, QStringList modalities, QString odir, qint64 &zipsize, qint64 &unzipsize, qint64 &numfiles, QString &msg);
