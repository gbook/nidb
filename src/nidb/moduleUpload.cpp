        ...
        while (q.next()) {
            ...
            if (numSeries > 0) {
                while (q2.next()) {
                    ...
                    if (io->GetSubject("patientid", subjectRowID, upload_destprojectid, uploadSubjectID, uploadSubjectName, uploadSubjectSex, uploadSubjectDOB, subjectRowID, subjectUID)) {
