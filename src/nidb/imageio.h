...
public:
    ...
    bool ConvertDicom(QString filetype, QString indir, QString outdir, QString bindir, bool gzip, bool json, QString uid, QString studynum, QString seriesnum, QString bidsSub, QString bidsSes, QString protocol, QString bidsSuffix, QString datatype, int &numfilesconv, int &numfilesrenamed, QString &msg);
