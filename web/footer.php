...
<table width="100%" cellspacing="0" cellpadding="6" style="background-color: 3b5998; border-top: 2px solid #35486D">
	<tr>
		...
		<td align="right" style="font-size:8pt; color: white">
			<span style="color: white; font-size:8pt; padding-right: 5px; padding-left: 5px">Problem, bug, or comment? <a href="https://github.com/NeuroInfoDB/nidb/issues" style="color:white">Report it</a></span>
		</td>
	</tr>
</table>
</div>
