...
<?
	...
	function AddPrefs($taskid, $edit_description, $edit_shortname, $edit_extralines, $edit_do_behmatchup, $edit_do_stats, $edit_do_censor, $edit_do_autoslice, $edit_do_db, $edit_beh_queue, $edit_beh_digits, $edit_stat_makeasciis, $edit_stat_asciiscript, $edit_stat_behdirname, $edit_stat_relativepath, $edit_stat_dirname, $edit_stat_pattern, $edit_stat_behunits, $edit_stat_volterra, $edit_stats_basisfunction, $edit_stat_onsetfiles, $edit_stat_durationfiles, $edit_stat_regressorfiles, $edit_stat_regressornames, $edit_stat_parameternames, $edit_stat_parameterorders, $edit_stat_parameterfiles, $edit_stat_censorfiles, $edit_stat_contrastmatrix, $edit_stat_xbflength, $edit_stat_xbforder, $edit_stat_timemodulation, $edit_stat_parametricmodulation, $edit_stat_globalfx, $edit_stat_highpasscutoff, $edit_stat_serialcorr, $edit_stat_autoslicecons, $edit_stat_autoslicep, $edit_stat_autoslicebackground, $edit_stat_autosliceslices, $edit_stat_autosliceemailcons, $edit_db_overwritebeta, $edit_db_fileprefix, $edit_db_betanums, $edit_db_threshold, $edit_db_smoothkernel, $edit_db_imcalcs, $edit_db_imnames) {
		...
		$edit_beh_queue = mysqli_real_escape_string($GLOBALS['linki'], $edit_beh_queue);
		$edit_beh_digits = mysqli_real_escape_string($GLOBALS['linki'], $edit_beh_digits);
		$edit_stat_behdirname = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_behdirname);
		...
		$edit_stat_asciiscript = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_asciiscript);
		$edit_beh_digits = mysqli_real_escape_string($GLOBALS['linki'], $edit_beh_digits);
		$edit_stat_dirname = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_dirname);
		$edit_stat_pattern = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_pattern);
		$edit_stat_behunits = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_behunits);
		if ($edit_stat_volterra == "yes") { $edit_stat_volterra = "1"; } else { $edit_stat_volterra = "0"; }
		$edit_stats_basisfunction = mysqli_real_escape_string($GLOBALS['linki'], $edit_stats_basisfunction);
		$edit_stat_onsetfiles = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_stat_onsetfiles));
		$edit_stat_durationfiles = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_stat_durationfiles));
		$edit_stat_regressorfiles = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_stat_regressorfiles));
		$edit_stat_regressornames = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_stat_regressornames));
		$edit_stat_parameternames = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_stat_parameternames));
		$edit_stat_parameterorders = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_stat_parameterorders));
		$edit_stat_parameterfiles = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_stat_parameterfiles));
		$edit_stat_censorfiles = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_stat_censorfiles));
		$edit_stat_timemodulation = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_timemodulation);
		$edit_stat_parametricmodulation = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_parametricmodulation);

		$cons = FormatContrastMatrix($edit_stat_contrastmatrix);
		$edit_stat_tcontrasts = $cons[0];
		//$edit_stat_tcon_columnlabels = $cons[1];
		$edit_stat_tcontrastnames = mysqli_real_escape_string($GLOBALS['linki'], $cons[2]);
		//$edit_stat_tcontrasts = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_tcontrasts);
		//$edit_stat_tcontrastnames = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_tcontrastnames);
		...
		$edit_stat_autoslicecons = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_autoslicecons);
		$edit_stat_autoslicebackground = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_autoslicebackground);
		$edit_stat_autosliceslices = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_autosliceslices);
		$edit_stat_autosliceemailcons = mysqli_real_escape_string($GLOBALS['linki'], $edit_stat_autosliceemailcons);
		if ($edit_db_overwritebeta == "yes") { $edit_db_overwritebeta = "1"; } else { $edit_db_overwritebeta = "0"; }
		$edit_db_fileprefix = mysqli_real_escape_string($GLOBALS['linki'], $edit_db_fileprefix);
		$edit_db_betanums = mysqli_real_escape_string($GLOBALS['linki'], $edit_db_betanums);
		$edit_db_smoothkernel = mysqli_real_escape_string($GLOBALS['linki'], $edit_db_smoothkernel);
		$edit_db_imcalcs = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_db_imcalcs));
		$edit_db_imnames = mysqli_real_escape_string($GLOBALS['linki'], FormatMatrix($edit_db_imnames));
	...
	function CopyToNew($taskid, $oldid) {
		...
		$do_db = $row['do_db'];
		$beh_queue = mysqli_real_escape_string($GLOBALS['linki'], $row['beh_queue']);
		$beh_digits = mysqli_real_escape_string($GLOBALS['linki'], $row['beh_digits']);
		$stats_makeasciis = $row['stats_makeasciis'];
		$stats_asciiscriptpath = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_asciiscriptpath']);
		$stats_behdirname = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_behdirname']);
		$stats_relativepath = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_relativepath']);
		$stats_dirname = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_dirname']);
		$stats_pattern = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_pattern']);
		$stats_behunits = $row['stats_behunits'];
		$stats_volterra = $row['stats_volterra'];
		$stats_basisfunction = $row['stats_basisfunction'];
		$stats_onsetfiles = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_onsetfiles']);
		$stats_durationfiles = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_durationfiles']);
		$stats_regressorfiles = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_regressorfiles']);
		$stats_regressornames = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_regressornames']);
		$stats_paramnames = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_paramnames']);
		$stats_paramorders = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_paramorders']);
		$stats_paramfiles = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_paramfiles']);
		$stats_censorfiles = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_censorfiles']);
		...
		$stats_tcontrasts = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_tcontrasts']);
		$stats_tcontrastnames = mysqli_real_escape_string($GLOBALS['linki'], $row['stats_tcontrastnames']);
		$autoslice_cons = mysqli_real_escape_string($GLOBALS['linki'], $row['autoslice_cons']);
		$autoslice_p = mysqli_real_escape_string($GLOBALS['linki'], $row['autoslice_p']);
		...
		$db_fileprefix = mysqli_real_escape_string($GLOBALS['linki'], $row['db_fileprefix']);
		$db_betanums = $row['db_betanums'];
		$db_threshold = $row['db_threshold'];
		$db_smoothkernel = $row['db_smoothkernel'];
		$db_imcalcs = mysqli_real_escape_string($GLOBALS['linki'], $row['db_imcalcs']);
		$db_imnames = mysqli_real_escape_string($GLOBALS['linki'], $row['db_imnames']);
