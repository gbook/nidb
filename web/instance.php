...
<?
	...
	function UpdateContact($id, $contactid, $contactfullname, $contacttitle, $contactaddress1, $contactaddress2, $contactaddress3, $contactcity, $contactstate, $contactcountry, $contactphone1, $contactphone2, $contactphone3, $contactemail1, $contactemail2, $contactemail3, $contactwebsite, $contactcompany, $contactdepartment) {
		/* perform data checks */
		$contactfullname = mysql_real_escape_string($contactfullname);
		$contacttitle = mysql_real_escape_string($contacttitle);
		$contactaddress1 = mysql_real_escape_string($contactaddress1);
		$contactaddress2 = mysql_real_escape_string($contactaddress2);
		$contactaddress3 = mysql_real_escape_string($contactaddress3);
		$contactcity = mysql_real_escape_string($contactcity);
		$contactstate = mysql_real_escape_string($contactstate);
		$contactcountry = mysql_real_escape_string($contactcountry);
		...
		$contactemail1 = mysql_real_escape_string($contactemail1);
		$contactemail2 = mysql_real_escape_string($contactemail2);
		$contactemail3 = mysql_real_escape_string($contactemail3);
		$contactwebsite = mysql_real_escape_string($contactwebsite);
		$contactcompany = mysql_real_escape_string($contactcompany);
		$contactdepartment = mysql_real_escape_string($contactdepartment);
