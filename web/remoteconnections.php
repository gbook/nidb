...
<?
	...
	function AddConnection($connname, $remoteserver, $remoteusername, $remotepassword, $remoteinstanceid, $remoteprojectid, $remotesiteid) {
		...
		$remoteinstanceid = mysql_real_escape_string($remoteinstanceid);
		$remoteprojectid = mysql_real_escape_string($remoteprojectid);
		$remotesiteid = mysql_real_escape_string($remotesiteid);
