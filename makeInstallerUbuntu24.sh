#!/bin/bash
# ------------------------------------------------------------------------------
# NiDB Ubuntu 24.04 (noble) package builder
...
# names a different build directory (e.g. bin/ubuntu24), as used by makeAllInstallers.sh.
#
# Same as the Debian 12 builder except for noble-specific package names:
#   - libglib2.0-0t64 replaces libglib2.0-0 (64-bit time_t transition)
# noble ships PHP 8.3 and MariaDB 10.11; the postinst detects the PHP version at
